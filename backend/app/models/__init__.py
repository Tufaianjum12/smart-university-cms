...
from app.models.academic import (
    AcademicStatus, CourseType, EnrollmentStatus, AttendanceStatus, AttendanceSessionStatus, AssessmentType, NotificationType, TargetType,
    ...
    Section, Enrollment, AttendanceSession, AttendanceRecord, Assessment, Grade, TimetableEntry,
